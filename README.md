# Reboot-V3-
Turn off Anti-Virus before downloading, as we are unsigned by all antivirus companies leaving us falsely flagged.
...
⚙️ Enable Super Client Mode in CCBOOT for Client PC and load it:
